...
const Sidebar = () => {
  ...
  return (
    <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
      <div className="bg-[#121212] h-[15%] rounded flex flex-col justify justify-around">
        <div
      ...
      <div className="bg-[#121212] h-[85%] rounded">
        ...
        <div className="p-4 m-2 bg-[#121212] rounded font-semibold flex flex-col items-start gap-1 pl-1 mt-4">
          <h1>Let's find some podcasts to follow</h1>
          <p>we'll keep update on new episodes</p>
